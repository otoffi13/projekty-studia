...
public class Renderer {
	...
	public void renderUI(Player player, Floor floorData, Graphics2D graphics, Point mousePosition) {
		...
		graphics.drawString("Zdrowie: "+player.getHealth()+"/"+player.getMaxHealth(), 10, 45);
		graphics.drawString("Siła: "+player.getStrength(), 10, 65);
		graphics.drawString("Obrona: "+player.getDefence(), 10, 80);
		graphics.drawString("Złoto: "+player.getGold(), 10, 100);
		...
		if(player.isInventoryOpen()) {
			...
			graphics.drawString("- Ekwipunek -", 160, 90);
			graphics.setFont(new Font("Dialog", Font.PLAIN, 20));
			graphics.drawString("Zdrowie: "+player.getHealth()+"/"+player.getMaxHealth()+"     Siła: "+player.getStrength()+"   Obrona: "+player.getDefence()+"     Złoto: "+player.getGold(), 160, 120);
		...
		if(player.getHealth() <= 0) {
			graphics.setColor(new Color(79, 19, 19));
			graphics.fillRoundRect(inventory.x, inventory.y, inventory.width, inventory.height, 10, 10);
			graphics.setColor(Color.WHITE);
			graphics.drawRoundRect(inventory.x, inventory.y, inventory.width, inventory.height, 10, 10);

			graphics.setFont(new Font("Dialog", Font.PLAIN, 40));
			graphics.drawString("Zginąłeś w lesie...", 200, 130);
			
			graphics.setFont(new Font("Dialog", Font.PLAIN, 30));
			graphics.drawString("Znalezione owce: "+player.getFloorsCleared(), 200, 200);
			graphics.drawString("Zdobyte złoto: "+player.getGold(), 200, 240);
			graphics.drawString("Naciśnij, aby zacząć ponownie", 200, 350);
		}
	}
	...
	public void renderMessageBox(MessageBox message, Graphics graphics) {
		...
		graphics.setColor(new Color(148, 141, 120));
	...
	public void renderTitleScreen(Graphics graphics) {
		...
		graphics.setFont(new Font("Dialog", Font.ITALIC, 40));
		graphics.drawString("Woods", 100, 100);
		graphics.setFont(new Font("Dialog", Font.PLAIN, 20));
		graphics.drawString(".", 100, 150);
		graphics.drawString("Znajdź wszystkie 10 owiec", 100, 180);
		graphics.drawString("które uciekły do lasu", 100, 210);
		graphics.drawString(".", 100, 240);
		graphics.drawString("Chodzenie: W, A, S, D", 100, 260);
		graphics.drawString("Ekwipunek: I", 100, 290);
		graphics.drawString("Interakcje: E", 100, 350);
	}
